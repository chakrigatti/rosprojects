...
# To view a urdf file in rviz  
ros2 launch urdf_tutorial display.launch.py model:=/humble-docker/robotic-arm-ws/src/mycobot_ros2/mycobot_description/urdf/mycobot_280_urdf.xacro
